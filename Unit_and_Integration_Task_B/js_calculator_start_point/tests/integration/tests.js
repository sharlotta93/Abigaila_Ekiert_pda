...
describe('calculator functionality', function() {
  ...
  it('should have number buttons which update running total', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should have expected output of decimals', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should have expected output of large number', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number3')).click();
